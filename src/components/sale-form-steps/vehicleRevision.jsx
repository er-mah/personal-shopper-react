...
import {MAIN_URLS, NEW_SALE_FORM_URLS, REVISION_OPTIONS,} from "../../utils/constants";
...
export function VehicleRevision({_step, setStep}) {
    ...
    const nextPage = () => {
        service.addRevisionDatesToDeal(revisionDates, formData.dealId).finally(() => {
                    ...
                    <div className="field flex-wrap col-12 md:col-7 lg:col-5">
                        <Calendar
                            ...
                            onChange={($event) => {
                                ...
                                setRevisionDates({
                                    saleMechanicalRevisionDates: storeDatesAsString($event.value),
                                });
